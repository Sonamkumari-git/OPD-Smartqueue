...
- [x] Add nurse-authorized edit and delete controls for patient-linked vital records and display the same observations to the assigned doctor during consultation.
