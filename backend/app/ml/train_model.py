...
from app.ml.features import CATEGORICAL, FEATURE_COLUMNS, NUMERIC, TARGET, feature_contract
...
def train_and_save() -> dict:
    ...
    joblib.dump({"pipeline": trained[best_name], "model_version": best_name, "feature_columns": FEATURE_COLUMNS, "feature_contract": feature_contract(), "dataset_notice": "Synthetic development data only; not real hospital data."}, MODEL_FILE)
    result = {"best_model": best_name, "metrics": metrics, "feature_contract": feature_contract(), "dataset_notice": "Synthetic development data only; not real hospital data."}
